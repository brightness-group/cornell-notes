<x-guest-layout>
    ...
    <x-auth-card>
        <x-slot name="logo">
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                ...
                <a href="{{ route('register') }}"
                   class="font-medium text-indigo-600 hover:text-indigo-500">{{ __('start your 30-day free trial ') }}</a>
            </p>
        </x-slot>
        ...
        <!-- Email Address -->
            ...
            <div>
                <x-button
                    class="w-full flex justify-center shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2">{{ __('Sign in') }}</x-button>
            </div>
        </form>
